...
!function(a) {
    ...
    a.extend(h.DEFAULTS, h.LOCALES["en-US"]),
    h.COLUMN_DEFAULTS = {
        radio: !1,
        checkbox: !1,
        checkboxEnabled: !0,
    ...
    h.prototype.initHeader = function() {
        ...
        a.each(this.options.columns, function(a, f) {
            ...
            f.visible && (h = b("text-align: %s; ", f.halign ? f.halign : f.align),
            i = b("text-align: %s; ", f.align),
            j = b("vertical-align: %s; ", f.valign),
            j += b("width: %spx; ", f.checkbox || f.radio ? 36 : f.width),
            d.push(f),
            c.header.fields.push(f.field),
            c.header.styles.push(i + j),
            c.header.classes.push(k),
            c.header.formatters.push(f.formatter),
            c.header.events.push(f.events),
            c.header.sorters.push(f.sorter),
            c.header.cellStyles.push(f.cellStyle),
            c.header.clickToSelects.push(f.clickToSelect),
            c.header.searchables.push(f.searchable),
            e.push("<th", f.checkbox || f.radio ? b(' class="bs-checkbox %s"', f["class"] || "") : k, b(' style="%s"', h + j), ">"),
            e.push(b('<div class="th-inner %s">', c.options.sortable && f.sortable ? "sortable" : "")),
            g = f.title,
            c.options.sortName === f.field && c.options.sortable && f.sortable && (g += c.getCaretHtml()),
            f.checkbox && (!c.options.singleSelect && c.options.checkboxHeader && (g = '<input name="btSelectAll" type="checkbox" />'),
            c.header.stateField = f.field),
            f.radio && (g = "",
            c.header.stateField = f.field,
        ...
        this.$loading.css("top", 0)) : (this.$header.show(),
    ...
    h.prototype.initData = function(a, b) {
        this.data = b ? this.data.concat(a) : a || this.options.data,
    ...
    h.prototype.initSort = function() {
        ...
        -1 !== e && this.data.sort(function(g, h) {
            ...
            return void 0 !== k ? d * k : (a.isNumeric(i) && (i = parseFloat(i)),
            a.isNumeric(j) && (j = parseFloat(j)),
            (void 0 === i || null  === i) && (i = ""),
            (void 0 === i || null  === j) && (j = ""),
            i === j ? 0 : j > i ? -1 * d : d)
        }
    ...
    h.prototype.initToolbar = function() {
        ...
        "string" == typeof this.options.toolbar && a('<div class="bars pull-left"></div>').appendTo(this.$toolbar).append(a(this.options.toolbar)),
        f = ['<div class="columns columns-' + this.options.toolbarAlign + " btn-group pull-" + this.options.toolbarAlign + '">'],
        this.options.showRefresh && f.push(b('<button class="btn btn-default" type="button" name="refresh" title="%s">', this.options.formatRefresh()), '<i class="fa fa-refresh icon-refresh"></i>', "</button>"),
        this.options.showToggle && f.push(b('<button class="btn btn-default" type="button" name="toggle" title="%s">', this.options.formatToggle()), '<i class="fa fa fa-list-alt icon-list-alt"></i>', "</button>"),
        this.options.showColumns && (f.push(b('<div class="keep-open btn-group" title="%s">', this.options.formatColumns()), '<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">', '<i class="fa fa-th icon-th"></i>', ' <span class="caret"></span>', "</button>", '<ul class="dropdown-menu" role="menu">'),
        a.each(this.options.columns, function(a, c) {
            if (!c.radio && !c.checkbox) {
                var d = c.visible ? ' checked="checked"' : "";
                c.switchable && (f.push(b('<li><label><input type="checkbox" data-field="%s" value="%s"%s> %s</label></li>', c.field, a, d, c.title)),
                h++)
            }
        }
        ),
        f.push("</ul>", "</div>")),
        f.push("</div>"),
        f.length > 2 && this.$toolbar.append(f.join("")),
        ...
        this.options.showColumns && (c = this.$toolbar.find(".keep-open"),
        h <= this.options.minimumCountColumns && c.find("input").prop("disabled", !0),
        c.find("li").off("click").on("click", function(a) {
        ...
        f.push('<div class="pull-' + this.options.searchAlign + ' search">', b('<input class="form-control" type="text" placeholder="%s">', this.options.formatSearch()), "</div>"),
    ...
    h.prototype.initPagination = function() {
        if (this.$pagination = this.$container.find(".fixed-table-pagination"),
        this.options.pagination) {
            var c, d, e, f, g, h, i, j, k, l = this, m = [], n = this.getData();
            "server" !== this.options.sidePagination && (this.options.totalRows = n.length),
            this.totalPages = 0,
            this.options.totalRows && (this.totalPages = ~~((this.options.totalRows - 1) / this.options.pageSize) + 1),
            ...
            m.push('<div class="pull-left pagination-detail">', '<span class="pagination-info">', this.options.formatShowingRows(this.pageFrom, this.pageTo, this.options.totalRows), "</span>"),
            m.push('<span class="page-list">');
            var o = ['<span class="btn-group dropup">', '<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">', '<span class="page-size">', this.options.pageSize, "</span>", ' <span class="caret"></span>', "</button>", '<ul class="dropdown-menu" role="menu">']
            ...
            o.push("</ul></span>"),
            m.push(this.options.formatRecordsPerPage(o.join(""))),
            m.push("</span>"),
            m.push("</div>", '<div class="pull-right pagination">', '<ul class="pagination">', '<li class="page-first"><a href="javascript:void(0)">&lt;&lt;</a></li>', '<li class="page-pre"><a href="javascript:void(0)">&lt;</a></li>'),
            ...
            (this.options.pageList.length < 2 || this.options.totalRows <= this.options.pageList[1]) && this.$pagination.find("span.page-list").hide(),
    ...
    h.prototype.initBody = function(d) {
        ...
        "server" === this.options.sidePagination && (i = this.data),
        ...
        for (var j = this.pageFrom - 1; j < this.pageTo; j++) {
            var k = i[j]
              ...
              , n = {}
              , o = [];
            if (l = f(this.options, this.options.rowStyle, [k, j], l),
            l && l.css)
                for (var p in l.css)
                    m.push(p + ": " + l.css[p]);
            ...
            h.push("<tr", b(" %s", o.join(" ")), b(' id="%s"', a.isArray(k) ? void 0 : k._id), b(' class="%s"', l.classes || (a.isArray(k) ? void 0 : k._class)), b(' data-index="%s"', j), ">"),
            this.options.cardView && h.push(b('<td colspan="%s">', this.header.fields.length)),
            a.each(this.header.fields, function(a, d) {
                var g = ""
                  ...
                  , o = {}
                  , p = ""
                  , q = e.header.classes[a];
                if (l = b('style="%s"', m.concat(e.header.styles[a]).join("; ")),
                i = f(e.header, e.header.formatters[a], [i, k, j], i),
                k["_" + d + "_id"] && (p = b(' id="%s"', k["_" + d + "_id"])),
                k["_" + d + "_class"] && (q = b(' class="%s"', k["_" + d + "_class"])),
                o = f(e.header, e.header.cellStyles[a], [i, k, j], o),
                o.classes && (q = b(' class="%s"', o.classes)),
                o.css) {
                    m = [];
                    for (var r in o.css)
                        m.push(r + ": " + o.css[r]);
                ...
                if (e.options.columns[a].checkbox || e.options.columns[a].radio) {
                    if (e.options.cardView)
                        return !0;
                    n = e.options.columns[a].checkbox ? "checkbox" : n,
                    n = e.options.columns[a].radio ? "radio" : n,
                    g = ['<td class="bs-checkbox">', "<input" + b(' data-index="%s"', j) + b(' name="%s"', e.options.selectItemName) + b(' type="%s"', n) + b(' value="%s"', k[e.options.idField]) + b(' checked="%s"', i === !0 || i && i.checked ? "checked" : void 0) + b(' disabled="%s"', !e.options.columns[a].checkboxEnabled || i && i.disabled ? "disabled" : void 0) + " />", "</td>"].join("")
                } else
                    i = "undefined" == typeof i || null  === i ? e.options.undefinedText : i,
                    g = e.options.cardView ? ['<div class="card-view">', e.options.showHeader ? b('<span class="title" %s>%s</span>', l, c(e.options.columns, "field", "title", d)) : "", b('<span class="value">%s</span>', i), "</div>"].join("") : [b("<td%s %s %s>", p, q, l), i, "</td>"].join(""),
                    e.options.cardView && e.options.smartDisplay && "" === i && (g = "");
                h.push(g)
            }
            ),
            this.options.cardView && h.push("</td>"),
            h.push("</tr>")
        }
        h.length || h.push('<tr class="no-records-found">', b('<td colspan="%s">%s</td>', this.header.fields.length, this.options.formatNoMatches()), "</tr>"),
        this.$body.html(h.join("")),
        d || this.scrollTo(0),
        this.$body.find("> tr > td").off("click").on("click", function() {
            var c = a(this).parent();
            e.trigger("click-row", e.data[c.data("index")], c),
            e.options.clickToSelect && e.header.clickToSelects[c.children().index(a(this))] && c.find(b('[name="%s"]', e.options.selectItemName))[0].click()
        }
        ),
        ...
        this.$selectItem = this.$body.find(b('[name="%s"]', this.options.selectItemName)),
        this.$selectItem.off("click").on("click", function(b) {
            b.stopImmediatePropagation();
            var c = a(this).prop("checked")
              , d = e.data[a(this).data("index")];
            d[e.header.stateField] = c,
            e.trigger(c ? "check" : "uncheck", d),
            e.options.singleSelect && (e.$selectItem.not(this).each(function() {
            ...
            if (c) {
                ...
                for (var d in c)
                    e.$body.find("tr").each(function() {
                        var f = a(this)
                          , g = f.find(e.options.cardView ? ".card-view" : "td").eq(b)
                          , h = d.indexOf(" ")
                          , i = d.substring(0, h)
                          , j = d.substring(h + 1)
                          , k = c[d];
    ...
    h.prototype.initServer = function(b) {
        ...
        d = f(this.options, this.options.queryParams, [e], d),
        d !== !1 && (b || this.$loading.show(),
        a.ajax({
            ...
            success: function(a) {
                ...
                var b = a;
                "server" === c.options.sidePagination && (c.options.totalRows = a.total,
                b = a.rows),
                c.load(b),
                c.trigger("load-success", b)
            },
            error: function(a) {
    ...
    h.prototype.updateSelected = function() {
        ...
        this.$selectAll.add(this.$selectAll_).prop("checked", b).change(),
    ...
    h.prototype.trigger = function(b) {
        ...
        b += ".bs.table",
        this.options[h.EVENTS[b]].apply(this.options, c),
    ...
    h.prototype.resetHeader = function() {
        ...
        return this.$el.is(":hidden") ? (clearTimeout(this.timeoutId_),
        void (this.timeoutId_ = setTimeout(a.proxy(this.resetHeader, this), 100))) : (this.$header_ = this.$header.clone(!0, !0),
        ...
        void setTimeout(function() {
            c.css({
                ...
                "margin-right": f
            }).find("table").css("width", b.$el.css("width")).html("").attr("class", b.$el.attr("class")).append(b.$header_),
            b.$header.find("th").each(function(c) {
            ...
            b.$el.css("margin-top", -b.$header.height()),
    ...
    h.prototype.toggleColumn = function(a, c, d) {
        if (-1 !== a && (this.options.columns[a].visible = c,
        this.initHeader(),
        this.initSearch(),
        this.initPagination(),
        this.initBody(),
        this.options.showColumns)) {
            ...
            d && e.filter(b('[value="%s"]', a)).prop("checked", c),
    ...
    h.prototype.resetView = function(a) {
        ...
        return this.options.cardView ? (b.$el.css("margin-top", "0"),
        void b.$container.find(".fixed-table-container").css("padding-bottom", "0")) : (this.options.showHeader && this.options.height && this.resetHeader(),
        void (this.options.height && this.options.showHeader && this.$container.find(".fixed-table-container").css("padding-bottom", "37px")))
    }
    ,
    ...
    h.prototype.checkAll_ = function(a) {
        ...
        this.updateRows(a),
        this.updateSelected(),
        this.trigger(a ? "check-all" : "uncheck-all")
    }
    ,
    ...
    h.prototype.check_ = function(a, c) {
        this.$selectItem.filter(b('[data-index="%s"]', c)).prop("checked", a),
        this.data[c][this.header.stateField] = a,
        this.updateSelected()
    }
    ,
    h.prototype.destroy = function() {
        ...
        this.$el.html(this.$el_.html()).attr("class", this.$el_.attr("class") || "")
    }
    ,
    ...
    ,
    a.fn.bootstrapTable.Constructor = h,
    a.fn.bootstrapTable.defaults = h.DEFAULTS,
    a.fn.bootstrapTable.columnDefaults = h.COLUMN_DEFAULTS,
    a.fn.bootstrapTable.locales = h.LOCALES,
    a.fn.bootstrapTable.methods = i,
    a(function() {
