...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHeader" runat="server">
    ...
    <link href="<%= ResolveUrl("~/main/assets/plugins/bootstrap-validator/bootstrapValidator.min.css")%>" rel="stylesheet" />
    ...
    <script>
                ...
                if (ticketNuevo)
                {
                    ...
                    $.ajax({
                        ...
                        success: function (msg)
                        {
                            ...
                            if (msg.d.Status == 1)
                            {
                                if(msg.d.IDProducto != null && msg.d.IDServicio == null)
                                {
                                    modalTextOKFactura(msg.d.BodyProducto,"Productos");
                                }
                                else if(msg.d.IDProducto == null && msg.d.IDServicio != null)
                                {
                                    modalTextOKFactura(msg.d.BodyServicio,"Servicios");
                                }
                                else if(msg.d.IDProducto != null && msg.d.IDServicio != null)
                                {
                                    modalTextOKFacturaDoble(msg.d.BodyProducto,msg.d.BodyServicio);
                                }
                                else
                                {
                                    ...
                                    $("#ctl00_ContentPlaceBody_sucursal").prop('disabled', 'disabled');
                                    $("#fechatkc").val('');
                                    $("#ticket").val('');
                                    $("#monto").val('');
                                }
        ...
        function remove(t)
        {
            ...
            if (!ticketexistintable)
                ...
                $("#ctl00_ContentPlaceBody_sucursal").prop('disabled', false);
        }
