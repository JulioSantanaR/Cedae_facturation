...
!function(a) {
    ...
    c.prototype.initToolbar = function() {
        if (this.showToolbar = this.options.showExport,
        ...
        this.options.showExport) {
            var c = this
              ...
              , f = e.find("div.export");
            if (!f.length) {
                f = a(['<div class="export btn-group">', '<button class="btn btn-default dropdown-toggle" data-toggle="dropdown" type="button">', '<i class="fa fa-file icon-file"></i> ', '<span class="caret"></span>', "</button>", '<ul class="dropdown-menu" role="menu">', "</ul>", "</div>"].join("")).appendTo(e);
